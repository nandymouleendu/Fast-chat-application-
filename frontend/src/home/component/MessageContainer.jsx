...
const MessageContainer = ({ onBackUser }) => {
    ...
    // FIX: images are now wrapped in a clickable <a> tag (target="_blank"),
    // same pattern as the doc link, so clicking opens the full-size image
    // in a new tab instead of doing nothing.
            ...
            return (
                <a href={media.url} target="_blank" rel="noopener noreferrer">
                    <img
                        src={media.url}
                        alt={media.fileName}
                        className="max-w-[220px] max-h-[220px] rounded-lg mb-1 object-cover cursor-pointer"
                    />
                </a>
            );
        }
