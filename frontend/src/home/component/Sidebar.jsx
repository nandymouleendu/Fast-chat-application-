...
const Sidebar = ({ onSelectUser }) => {
    ...
    // Global "new message" listener — always mounted, so this fires
    // for every incoming message no matter whose chat you have open.
    useEffect(() => {
        if (!socket) return;
        ...
        const handleNewMessage = (newMessage) => {
            ...
            // Always play notification sound, regardless of which chat is open
